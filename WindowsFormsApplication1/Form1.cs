...
namespace WindowsFormsApplication1
{
	public class Form1 : Form
	{
		...
		private ElapsedEventHandler timers2_Elapsed;
		...
		private void InitializeComponent()
		{
			...
			comboBox1.SelectedIndex = junkie.Next(8);
		...
		internal void SpellOut(int p)
		{
			...
			if (gfx != null)
			{
				...
				for (int j = 0; j < p; j++)
				{
					gfx.DrawString(list[j], new Font("Arial", 48f), Brushes.White, 200 + size.Width + num, 100 + num2);
